...
<head>
    ...
    <style type="text/css">
		...
		.weeks-ago {	height: 19px;	width: 80px;	color: #B5B5B5;	font-family: 'Lato', sans-serif !important;	font-size: 16px;	font-style: italic;	line-height: 19px;}
	...
	<?php foreach ($response as $key) { ?>
		<div class="row group-2">
			...
			<div class="col-sm-2 col-md-2 col-lg-2 job-location">
				<?php echo $key['location']; ?> &nbsp
				<a href="<?php echo site_url('job_details/'.$key['code']) ?>" target="_blank"><i class="fa fa-chevron-right" style="color:#515151;"></i></a>
			</div>
			<div class="col-sm-1 col-md-1 col-lg-1"></div>
		</div>
